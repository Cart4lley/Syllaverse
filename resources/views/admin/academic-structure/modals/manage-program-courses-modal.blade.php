...
<div class="modal fade" id="manageCoursesModal" tabindex="-1" aria-labelledby="manageCoursesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{-- 🟥 Map Course Form --}}
            <form id="mapCourseForm" method="POST" action="{{ route('admin.program-courses.store') }}">
                @csrf
            ...
            {{-- 🟩 Mapped Courses Section (Using POST fallback for delete) --}}
            <div class="px-4 pb-4">
                <hr class="my-4">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered small mb-0">
                        ...
                        <tbody id="programCourseList">
                            @forelse ($programCourseMap as $map)
                                <tr>
                                    ...
                                    <td>
                                        {{-- ✅ Using fallback POST route for deletion --}}
<form action="{{ route('admin.program-courses.fallback', $map->id) }}" method="POST">
    @csrf

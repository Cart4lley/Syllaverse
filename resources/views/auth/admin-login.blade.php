            ...
            <div
                ...
                <div class="w-100">
                    ...
                    <h2 class="fw-bold mb-3 position-relative tagline">
                        Create & Manage Syllabi Effortlessly
                    </h2>

                    {{-- Description --}}
                    <p class="px-3 position-relative description">
                        Syllaverse empowers faculty and administrators to <strong>create, organize, and monitor</strong>
                        syllabi and academic progress seamlessly — all tailored for Batangas State University.
                    </p>

                    {{-- Quote --}}
                    <blockquote class="text-light mt-4 fst-italic position-relative quote">
                        "Building better syllabi builds better futures."
                    </blockquote>
